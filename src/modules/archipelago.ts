...
class RCTRArchipelago extends ModuleBase {
    ...
    public AnyEntry(): void {//Loads on save file load and refreshing the code
        var self = this;
    ...
    public CreateObjectiveList(): any {
        var self = this;
        var objective = [];
    ...
    public FirstEntry(): void {//Loads on park starting for first time. Something in my code calls it as well
        var self = this;
    ...
    public IsVisible(LockedID): boolean {
    ...
    public ReceiveArchipelagoItem(item): void {
        var self = this;
    ...
    public ReceiveDeathLink(DeathLinkPacket: { cause: string, source: string }): any {
        var self = this;
    ...
    public ReleaseRule(rule): void {//Function that ends enforcement of detrimental park modifiers
    ...
    public SendDeathLink(vehicleID): any {
    ...
    public SetArchipelagoResearch(): void {
